function calibrationFactor = get_calibration_factor_230830(date,N_projection)
...
[center,radii] = find_fibers_16ch(calibrationImage,radiusRange);
IW = mean(radii);
timeSeries = zeros(2,4,2*IW,2*IW);
center = round(center);
