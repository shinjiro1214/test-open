...
matrixPathMatrix = strings(3,3);
matrixPathMatrix(1,1) = [pathFirstHalf,'29/2.mat'];
% matrixPathMatrix(2,2) = [pathFirstHalf,'29/3.mat'];
matrixPathMatrix(1,2) = [pathFirstHalf,'28/4.mat'];
matrixPathMatrix(1,3) = [pathFirstHalf,'29/4.mat'];
matrixPathMatrix(2,1) = [pathFirstHalf,'12/2.mat'];
matrixPathMatrix(2,2) = [pathFirstHalf,'25/3.mat'];
matrixPathMatrix(2,3) = [pathFirstHalf,'29/4.mat'];
matrixPathMatrix(3,1) = [pathFirstHalf,'18/2.mat'];
matrixPathMatrix(3,2) = [pathFirstHalf,'7/3.mat'];
...
for i = 1:3
    ...
    load(matrixPathMatrix(1,i),'EE2');
    load(matrixPathMatrix(2,i),'EE3');
    load(matrixPathMatrix(3,i),'EE4');

    EE = cat(3,EE2,EE3,EE4);
    % 負の要素を0で置換
