...
date_4kV = '240827';
[date_5kV, date_6kV] = deal('240828');
shotList_4kV = [11:20, 22:32, 34:45, 47:51];%4kV
shotList_5kV = [30:41, 43:46, 48:54];%5kV
shotList_6kV = [3:12, 14:22, 25:29];%6kV
dateList = {date_4kV,date_5kV,date_6kV};
shotList = {shotList_4kV,shotList_5kV,shotList_6kV};
...
for i = 1:numel(shotList)
    ...
    dirPath = fullfile(pcbDataDir,cell2mat(dateList(i)));
    j=1;
    for k = shotList_tmp
        % disp(k);
        % PCB = get_PCB_data(str2double(cell2mat(dateList(i))),k,0,0);
