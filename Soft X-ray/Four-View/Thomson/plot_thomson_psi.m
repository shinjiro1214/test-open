...
f1 = figure('Position', [0 0 1500 1500],'visible','on');t1=tiledlayout(2,4,'TileSpacing','compact','Padding','compact');
f2 = figure('Position', [0 0 1500 1500],'visible','on');t2=tiledlayout(2,4,'TileSpacing','compact','Padding','compact');
% i=1;
for i = 1:7
    ...
    contourf(zq(1,:),rq(:,1),Te_q.',linspace(0,10,10),'LineStyle','none');
    if i==7
        c1=colorbar;
        c1.Layout.Tile='east';
    end
