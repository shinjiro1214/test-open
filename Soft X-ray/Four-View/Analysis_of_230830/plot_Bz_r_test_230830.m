...
date = '230830';
shotList = [16 17 20 22:23 25 32 34 41:45 47 49 51 54 55 57];

t = 451:480;
% [Bz_mean,Bz_std] = deal(zeros(1,40));
...
Bz_mean = mean(Bz_r,'omitmissing');
Bz_std = std(Bz_r,'omitmissing');

figure; hold on;
% for i = 1:numel(shotList)
    errorbar(r_vec,Bz_mean,Bz_std);
% end
