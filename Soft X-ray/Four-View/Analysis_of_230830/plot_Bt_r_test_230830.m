...
date = '230830';
shotList = [16 17 20 22:25 32 34 37 41:45 47 49:51 54:57];

t = 451:480;
% [Bt_mean,Bt_std] = deal(zeros(1,40));
...
Bt_mean = mean(Bt_r,'omitmissing');
Bt_std = std(Bt_r,'omitmissing');

figure; hold on;
% for i = 1:numel(shotList)
    errorbar(r_vec,Bt_mean,Bt_std);
% end
