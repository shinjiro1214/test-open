    ...
    %  figure(f1);subplot(2,2,m);
     ...
     switch(PCB.type)
        ...
        case 3 %Bt
            ...
            % contourf(grid2D.zq(1,:),grid2D.rq(:,1),data2D.Bt(:,:,i),-0.05:0.005:0.05,'LineStyle','none');clim([-0.05,0.05]);colormap(redblue(3000));%Spheromak
            % contourf(grid2D.zq(1,:),grid2D.rq(:,1),abs(data2D.Bt_th(:,:,i)),0:1e-2:0.4,'LineStyle','none')
            contourf(grid2D.zq(1,:),grid2D.rq(:,1),abs(data2D.Bt(:,:,i)),0:1e-2:0.4,'LineStyle','none')
        case 4 %Br
            ...
            figure(f2);subplot(4,4,m);plot(zq(1,:),Br_mean);figure(f1);colormap(redblue(3000));
        ...
        case 13 %Energy gain
            ...
            Et_q = griddata(grid2D.zq(1,:),grid2D.rq(:,1),data2D.Et(:,:,i),zq,rq);
            Jt_q = griddata(grid2D.zq(1,:),grid2D.rq(:,1),data2D.Jt(:,:,i),zq,rq);
            contourf(zq(1,:),rq(:,1),Et_q.*Jt_q,50,'LineStyle','none');clim([-3e8,3e8]);%Power
        case 14 %resistivity
            [zq,rq] = meshgrid(linspace(-0.1,0.1,200),linspace(0.2,0.32,200));
            Et_q = griddata(grid2D.zq(1,:),grid2D.rq(:,1),data2D.Et(:,:,i),zq,rq);
            Jt_q = griddata(grid2D.zq(1,:),grid2D.rq(:,1),data2D.Jt(:,:,i),zq,rq);
