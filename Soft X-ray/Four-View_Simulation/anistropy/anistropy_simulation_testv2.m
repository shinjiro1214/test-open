...
fprintf('    Calculating Projection with Anisotropy...\n');
[~, S_obs_val_phys] = Compute_Projection_Normalized(l_up, Geom, Phys, F_E_true, F_Br, F_Bz, F_Bt, F_Emission_LUT);
scale_factor_adjustment = 100; 
S_obs_val = S_obs_val_phys * scale_factor_adjustment;
