% function [] = plot_SXR_ne(pathname)
    ...
    errorbar(r_space_SXR, SXR_r_mean, SXR_r_std, 'LineWidth', 2, ...
        'Marker', 'o', 'MarkerSize', 6, 'CapSize', 0);
    ...
    yyaxis right
    if ne_data_ready
        % ★ここを errorbar に変更しました
        errorbar(R_values, ne_mean, ne_std, 'LineWidth', 2, ...
            'Marker', 's', 'MarkerSize', 8, 'CapSize', 8, ...
            'LineStyle', '-');
    else
        plot(nan, nan);
    end
